...
* ### 단수를 복수로 만들 때의 규칙
    ...
    * -s  
    ex. lunes  
    ! 혼성 복수는 항상 남성 복수로 ex. hijo + hija = hijos
...
* ### 인칭 대명사
    ...
    !. vosotros와 ellos 헷갈리지 않게 주의. vosotros 는 '너희', ellos... = 그들
...
* ### 의문사 : Qué, Quién
    * Quién/Quiénes(=who)
    ex. Q : ¿Quién eres tú? A : Soy amigo de Juan.
    * Qué(=what)
    ex. ¿Qué es el amor?  
* ### 소유사 : Mi, Tu, Su
    mi | mis  
...
* ### Hay동사 : ~가 있다.
    ...
    * Hay는 절대 정관사(=the)와 같이 오지 않는다.  
    !. en(=in), no는 항상 동사 앞에
* ### Estar동사 : ~가 있다.
    * Be동사 의미 외에도, 구체적인 주어의 위치나   장소를 나타낼 수 있다.
    * 정관사 = Estar동사, 정관사X = Hay동사
